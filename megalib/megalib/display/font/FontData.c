...
| Erstellung:   3.3.2022
|
| Aenderung:    Dritter Zeichensatz 3x5, fontParam schreibgeschuetzt
\*-------------------------------------------------------------------------*/
#include <avr/pgmspace.h>
#include "FontData.h"

// Auswahl des Zeichensatzes. Genau einer muss aktiv sein.
// Achtung: die Wahl gilt fuer das ganze Projekt. display.c rechnet
// Zeilen und Spalten aus Breite, Hoehe und Abstand, mit einem anderen
// Satz landen alle Ausgaben von display_string_pos woanders.
// #define FONT_7x8
// #define FONT_5x8
#define FONT_3x5
...
const FontParam_t fontParam = {32, 129, 7, 8, 1};
...
// erstes Zeichen, letztes Zeichen
// Fontbreite, Fonthoehe, Fontspacing
const FontParam_t fontParam = {32, 127, 5, 8, 2};
...
// Sehr kleiner Zeichensatz, je Zeichen drei Spalten zu fuenf Pixeln.
// Von Hand entworfen, nicht aus dem 5x8 verkleinert: beim Verkleinern
// gehen Striche verloren, hier ist jeder Strich bewusst gesetzt.
// Grossbuchstaben, Ziffern und die ueblichen Satzzeichen sind
// vollstaendig, Kleinbuchstaben sind bei fuenf Pixeln Hoehe eng.

// erstes Zeichen, letztes Zeichen
// Fontbreite, Fonthoehe, Fontspacing
const FontParam_t fontParam = {32, 127, 3, 5, 1};
...
const unsigned char fontData[] PROGMEM =
{
   ...
   0x1F, 0x14, 0x08,   // b 98
   0x0C, 0x12, 0x12,   // c 99
   0x08, 0x14, 0x1F,   // d 100
   0x0C, 0x1A, 0x14,   // e 101
   0x04, 0x1E, 0x05,   // f 102
   0x14, 0x1A, 0x0E,   // g 103
   0x1F, 0x04, 0x18,   // h 104
   0x00, 0x1D, 0x00,   // i 105
   0x08, 0x10, 0x0D,   // j 106
   0x1F, 0x0C, 0x12,   // k 107
   0x01, 0x1F, 0x10,   // l 108
   0x1C, 0x0C, 0x1C,   // m 109
   0x1C, 0x04, 0x18,   // n 110
   0x08, 0x14, 0x08,   // o 111
   0x1E, 0x0A, 0x04,   // p 112
   0x04, 0x0A, 0x1E,   // q 113
   0x1e, 0x02, 0x02,   // r 114
   0x10, 0x16, 0x0A,   // s 115
   0x02, 0x0F, 0x12,   // t 116
   0x0C, 0x10, 0x1C,   // u 117
   0x0C, 0x10, 0x0C,   // v 118
   0x1C, 0x18, 0x1C,   // w 119
   0x14, 0x08, 0x14,   // x 120
   0x12, 0x14, 0x0E,   // y 121
   0x1A, 0x16, 0x12,   // z 122
   0x04, 0x0E, 0x11,   // { 123
   0x00, 0x1F, 0x00,   // | 124
   0x11, 0x0E, 0x04,   // } 125
   0x0C, 0x04, 0x06,   // ~ 126
